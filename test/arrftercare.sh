#!/bin/bash
# WARNING, This script is unmodularized, does not work with Sonarr/Radarr unless FFMPEG/FFPROBE are either built in them or mapped externally.
# Use the other one. Blame crap docker image builders.
